...
[^4]: This is not a problem for realism: When one seeks a script for an enternaining action movie, one biases their story search towards those including catastrophies so that the hero can shine. When one looks for a possible future one wants to live in, they search the story space for the subset of stories that are hopeful and positive. In both cases, this does not limit the scenarios in being realistic, likely, or attainable. If they ultiately come to pass depends on who takes what action. It is the intention of future scenarios to make us act towards those we deem worth living in.
[^5]: [ai-2027.com](https://ai-2027.com/).
[^6]: [The hater's guide to the AI bubble](https://www.wheresyoured.at/the-haters-gui/).
