...
| 2020 | robust deep learning | conf. paper | Stefan Glüge, Mohammadreza Amirian, Dandolo Flumini, and Thilo Stadelmann. ["**How (Not) to Measure Bias in Face Recognition Networks**"](https://stdm.github.io/downloads/papers/ANNPR_2020.pdf). In: Proceedings of the 9th IAPR TC 3 Workshop on Artificial Neural Networks for Pattern Recognition (**ANNPR'20**), Springer, LNAI, Winterthur, Switzerland, September 02-04, 2020. |
