...
| 2018 | optical music recognition | workshop paper | Ismail Elezi, Lukas Tuggener, Marcello Pelillo, and Thilo Stadelmann. [**"DeepScores and Deep Watershed Detection: current state and open issues"**](https://stdm.github.io/downloads/papers/ANNPR_2018d.pdf). In: Proceedings of the 1st International Workshop on Reading Music Systems (**WoRMS'18**), Paris, France, September 20, 2018. |
