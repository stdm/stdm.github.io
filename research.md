...
| --- | --- | --- | --- |
| 2021 | TEACHING | journal paper | Thilo Stadelmann, Hulian Keuzenkamp, Helmut Grabner, and Christoph Würsch. ["**The AI Atlas: Didactics for Teaching AI and Machine Learning On-Site, Online, and hybrid**"](https://www.mdpi.com/2227-7102/11/7/318/pdf). **Educ. Sci.** 2021, 11, 318, MDPI, Basel, Switzerland, June 25, 2021. |
...
| 2020 | teaching | technical report | Thilo Stadelmann, and Christoph Würsch. ["**Maps for an Uncertain Future: Teaching AI and Machine Learning Using the ATLAS Concept**"](https://stdm.github.io/downloads/papers/TR_2020.pdf). Technical report (didactic concept), ZHAW, Winterthur, Switzerland, 2020. |
