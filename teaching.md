...
| Tag | Name | Format | Type | Content | Did what? | When? |
| --- | --- | --- | --- | --- | --- | --- |
| MAS AI | **Master of Advanced Studies in Artificial Intelligence** | on-premise multi-year programme | continuing education courses including CAS PAIR 1&2, CAS ADML, CAS FAIM, etc.  | complete continuing education programme in modern AI and ML | initiate, co-create| Fall 2025 |
| CAS PAIR 1&2| **Certificate of Advanced Studies in Physical AI and Robotics** | on-premise full semester course | continuing education courses (foundational & advanced) | AI/ML-based (mobile) robotics for engineers | initiate, co-create | Fall 2025 |
...
| CAS ADML | **Certificate of Advanced Studies in Advanced Machine Learning and Machine Learning Operations** | on-premise one-year continuing education programme | thorough introduction to MLOps and societal aspects of applied AI, advanced machine learning for computer vision and control | initiate | Fall 2022 |
...
| CAS FAIM | **Certificate of Advanced Studies in Foundations of AI and Machine Learning** | on-premise one-year continuing education programme | thorough introduction to applied machine and deep learning | initiate, co-create, module responsible| Spring 2017 |
...
| MAS DASC | **Master of Advanced Studies in Data Science** | on-premise multi-year programme | continuing education program | technically oriented data science education for university alumnis | co-initiate, co-create | Spring 2014-2015 |  
